...
exports.postBeers = function(req, res) {
  ...
  beer.save(function(err) {
    console.log('1.controller beer postBeers save : ', beer)
    if (err)
      return res.send(err);
...
exports.getBeers = function(req, res) {
  ...
  Beer.find(query, function(err, beers) {
    console.log('1.controller beer getBeers : ', query, beers)
    if (err)
      return res.send(err);
...
exports.getBeer = function(req, res) {
  ...
  Beer.find(query, function(err, beer) {
    console.log('1.controller beer getBeer : ', query, beer)
    if (err)
      return res.send(err);
