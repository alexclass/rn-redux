...
const alexImageUrl = 'https://avatars1.githubusercontent.com/u/3205347?s=400&v=4'
const alexImageUrlDesc = 'github image for alex2006hw'

class CreatePage extends React.Component {

  state = {
    description: alexImageUrlDesc,
    imageUrl: alexImageUrl,
  }
  ...
  render () {
   ...
   _createPost = async () => {
    console.log('1.createpage _createPost : ', this.state)
